...
public class DrawPointSubscriber implements MqttCallback, Runnable{
    private final static String BROKER = "tcp://test.mosquitto.org:1883";
    private final static String TOPIC = "draw_points_client";
    private final static String TOPIC_TO_SUB = "draw_points_server";
    private final static String CLIENT_ID = "subscriber";

    private MqttClient client;

    public DrawPointSubscriber() {
        try {
